...
| `wcdw-logo-clean-fifth-third.png` | Official 2026 event logo, clean version (2000×1414) with the "Presented by Fifth Third Bank" lockup. Hosted for emails at `https://laurarestum.github.io/envision-wcdw-media-guide/assets/logos/white-cane-day-walk-logo.png` — every email footer uses that URL. |
